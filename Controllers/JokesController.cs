...
using FCF_JokesWebApp.Data;
using FCF_JokesWebApp.Models;

namespace FCF_JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            var jokes = await _context.Joke.Where(joke => joke.JokeQuestion.Contains(SearchPhrase)).ToListAsync();
            return _context.Joke != null ?
                          View("Index", jokes) :
                          Problem("Entity set 'ApplicationDbContext.Joke'  is null.");
        }
